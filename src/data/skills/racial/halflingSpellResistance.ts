...
export const halflingSpellResistance: SkillEntity = {
  id: 'halflingSpellResistance',
  name: 'Spell Resistance - Halfling',
  family: 'utility',
      ...
      prerequisites:
        index === 0
          ...
          : [
              {
                type: 'skill',
                skillId: 'halflingSpellResistance',
                tier: tier - 1,
              },
              { type: 'level', minimum: levels[index] },
            ],
      freeForRaces: [{ raceId: 'Halfling', atLevel: levels[index] }],
      effects: [
        {
          target: 'spell_resistance_bonus',
          operation: 'add',
          value: delta,
          sourceSkill: 'halflingSpellResistance',
          tier,
        },
      ],
    };
